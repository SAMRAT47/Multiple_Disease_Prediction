...
from src.diseases.diabetes.components.data_ingestion import DataIngestion
from src.diseases.diabetes.components.data_validation import DataValidation
...
class DiabetesTrainPipeline:
    def __init__(self):
        self.disease_name = "diabetes"
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            data_ingestion = DataIngestion(data_ingestion_config=self.data_ingestion_config, disease_name=self.disease_name)
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        ...
        try:
            data_validation = DataValidation(data_ingestion_artifact=data_ingestion_artifact,
                                             data_validation_config=self.data_validation_config,disease_name=self.disease_name
                                             )
