...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            if dataframe.empty:
                raise ValueError("Exported dataframe is empty. Check MongoDB collection and query.")
            
            # Proceed with file saving and return if data is not empty
